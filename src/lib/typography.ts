...
export const PAGE_TITLE =
  "text-balance font-display text-[30px] font-bold leading-[1.1] tracking-[-0.025em] sm:text-[38px] md:text-[44px]";

export const SECTION_TITLE =
  "text-balance font-display text-[26px] font-bold leading-[1.15] tracking-[-0.025em] sm:text-[32px] md:text-[36px]";
